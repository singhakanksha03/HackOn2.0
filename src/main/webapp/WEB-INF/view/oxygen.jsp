<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
	...
	<body>
		...
		<div class="div" id="rem">
		<div class="container-fluid text-center">
			<div class="text-center mt-5 mb-0 pt-0">
                        <a href="/view-form" class="btn btn-outline-dark btn-md button">SEARCH FOR OXYGEN</a>
                    </div>
		...
		<div class="container-fluid text-center">
			...
			<p class="mt-2 mb-0 pt-0 heading">
				<b>INSERT DATA FOR OXYGEN</b>
			</p>
			<div class="hd-border w-50 mb-3 mx-auto"></div>
			<!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni tempore hic eius, necessitatibus omnis rem optio id voluptatem tenetur adipisci facilis temporibus modi quia, nulla eos culpa quae dolorem corrupti.</p> -->
			<form action="/oxygen-data" class="form-inline" method="post">

				<div class="common-div p-3 pt-0 mb-3 mx-auto">
					<br>
					<div class="form-group">
						<label for="name" class="control-label col-sm-3 ">Name Of Hospital/Store:</label> <input type="text"
							class="form-control col-sm-9" id="name" placeholder="Enter name" name="name" Required>
					</div>
					<br>
					...
					<div class="form-group">
						<label for="address" class="control-label col-sm-3">Address:</label> <input type="text"
							class="form-control col-sm-9" id="address" placeholder="Enter address" name="address"
					...
					<div class="form-group">
						<label for="phone" class="control-label col-sm-3">Phone no.:</label> <input type="phonenumber"
							class="form-control col-sm-9" id="phone" placeholder="Enter Phone" name="phone" Required>
					</div>
					<br>
					<div class="mx-auto">
